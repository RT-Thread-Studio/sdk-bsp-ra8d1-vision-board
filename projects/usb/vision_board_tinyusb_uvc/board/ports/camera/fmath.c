...
#include <math.h>
float inline __attribute__((always_inline)) fast_sqrtf(float x) {
    return sqrtf(x);
}

int inline __attribute__((always_inline)) fast_floorf(float x) {
    return floorf(x);
}

int inline __attribute__((always_inline)) fast_ceilf(float x) {
    return ceilf(x);
}

int inline __attribute__((always_inline)) fast_roundf(float x) {
    return roundf(x);
}

float inline __attribute__((always_inline)) fast_fabsf(float x) {
    return fabsf(x);
}
