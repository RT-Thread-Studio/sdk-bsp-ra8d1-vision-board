...
{
    /* Actual calculated bitrate: 99992. Actual SDA delay: 258.33 ns. */ .clock_settings.clk_divisor_value = 0, .clock_settings.brr_value = 22, .clock_settings.mddr_value = 157, .clock_settings.bitrate_modulation = true, .clock_settings.cycles_value = 31,
