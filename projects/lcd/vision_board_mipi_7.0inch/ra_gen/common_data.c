...
const uint8_t DRW_INT_IPL = (2);
            d2_device *   d2_handle;
/* MIPI PHY Macros */
        #define MIPI_PHY_CLKSTPT   (1129.8333333333333)
        #define MIPI_PHY_CLKBFHT   (13 + 1)
        #define MIPI_PHY_CLKKPT    (28 + 4)
        #define MIPI_PHY_GOLPBKT   (55)

        #define MIPI_PHY_TINIT     (71999)
        #define MIPI_PHY_TCLKPREP  (8)
        #define MIPI_PHY_THSPREP   (5)
        #define MIPI_PHY_TCLKTRAIL (7)
        #define MIPI_PHY_TCLKPOST  (15)
        #define MIPI_PHY_TCLKPRE   (1)
        #define MIPI_PHY_TCLKZERO  (27)
        #define MIPI_PHY_THSEXIT   (11)
        #define MIPI_PHY_THSTRAIL  (7)
        #define MIPI_PHY_THSZERO   (18)
        ...
        {
            .pll_settings = /* Actual MIPI PHY PLL frequency: 20000000 Hz / 1 * 72.00 = 1440000000 Hz (error 0.00%) */{.div      = 1 - 1,.mul_int  = 72 - 1,.mul_frac = 0},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .vertical_back_porch      = (23 - 1),
            .vertical_front_porch     = (635 - 600 - 23 - 1),
            .vertical_sync_polarity   = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),


            .horizontal_active_lines  = 1024,
            .horizontal_sync_lines    = 10,
            .horizontal_back_porch    = (160 - 10),
            .horizontal_front_porch   = (1344 - 1024 - 160 - 10),
            .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

            .video_mode_delay         = 770 /* This value was calculated by FSP. An override is available but not recommended for most users */,
